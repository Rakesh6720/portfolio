    ...
    >
      <div className={`${id === 6} && 'flex justify-center h-full'`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex-col px-4 p-5 lg:p-10"
          )}
        >
          <div className="font-sans font-bold text-neutral-600 dark:text-neutral-200 mb-2 mt-2">
            {description}
          </div>
          <div className="font-sans font-bold text-lg  lg:text-3xl max-w-96 z-10 sm:text-xs">
            {title}
          </div>
        </div>
      </div>
